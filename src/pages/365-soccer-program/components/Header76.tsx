    ...
    >
      <div className="mx-[5%] max-w-[40rem] justify-self-start lg:mr-20 lg:ml-[5vw] lg:justify-self-end">
        <h1 className="mb-5 text-6xl font-bold md:mb-6 md:text-9xl lg:text-10xl">
          Empowering Future Stars Through Faith and Sports
        </h1>
        <p className="md:text-md">
          At the 365 Soccer Program, we cultivate champions both on and off the
          field. Our commitment to holistic development ensures that every child
          excels in sports, character, and academics.
        </p>
